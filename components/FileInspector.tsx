    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            {/* 2. Line Items Table */}
            <div>
                <h4 className="text-lg font-medium text-gray-800 mb-4 pb-1 border-b">Detailed Line Items ({data.lines.length})</h4>
                    ...
                    <table className="min-w-full text-xs divide-y divide-gray-200">
                        <thead className="bg-gray-100 sticky top-0 z-10 shadow-sm">
                            <tr>
                                ...
                                <th className={`px-3 py-2 text-right font-medium ${getColumnClass('Discount', 'text-gray-500')} bg-gray-100`}>Disc 1</th>
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {data.lines.map((line, idx) => {
                                ...
                                // Calculation Breakdowns for Tooltips
                                    ...
                                    <td className="px-3 py-2 text-gray-400 font-mono text-[10px] relative">
                                        ...
                                        {hasIssues && (
                                            ...
                                            >
                                                ...
                                                {/* Tooltip */}
                                                <div className="absolute left-6 top-1/2 -translate-y-1/2 w-max max-w-xs p-2 bg-gray-900 text-white text-xs rounded shadow-lg z-50 hidden group-hover:block whitespace-pre-wrap">
                                                    {issues.join('\n')}
                                                </div>
                                            </div>
                                        )}
                        ...
                        <tfoot className="bg-gray-50 font-bold sticky bottom-0 z-10 border-t shadow-[0_-1px_2px_rgba(0,0,0,0.05)]">
                            <tr>
                                <td colSpan={3} className="px-3 py-2 text-right text-gray-700">TOTALS (Sum):</td>
